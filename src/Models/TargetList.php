...
namespace Joy\VoyagerBreadTargetList\Models;
...
use Joy\VoyagerBreadTargetList\Database\Factories\TargetListFactory;
...
class TargetList extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('TargetList'));
    }
